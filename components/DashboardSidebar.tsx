...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ role }) => {
  ...
  const items = role === 'USER' ? userItems : role === 'DOCTOR' ? doctorItems : adminItems;

  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-white border-r border-gray-200 shadow-sm z-30 overflow-y-auto hidden md:block">
